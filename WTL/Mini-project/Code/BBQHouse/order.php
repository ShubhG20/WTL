...
<select id="item" name="item">
  <option value="V01">Crispy Corn</option>
    <option value="V02">Cajun Potatoes</option>
	  <option value="V03">Shahi Paneer</option>
	    <option value="V04">Veg Biryani</option>
		  <option value="NV01">Chicken Wings</option>
		    <option value="NV02">Butter Chicken</option>
  <option value="NV03">Mutton Biryani</option>  <option value="D01A">Margarita(S)</option>  
